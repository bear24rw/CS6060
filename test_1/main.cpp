...
int main()
{
    ...
    glm::mat4 cam_body_mcs   = glm::translate(glm::mat4(1.0f), glm::vec3( 1.0f, -3.0f, -1.5f));
    glm::mat4 cam_lens_mcs   = glm::translate(glm::mat4(1.0f), glm::vec3( 1.5f, -4.0f, -0.5f));
    ...
    glm::mat4 shaft_ocs = glm::mat4(1.0f);
              //shaft_ocs = glm::rotate(shaft_ocs, 30.0f, glm::vec3(1,0,0));
    ...
    glm::mat4 cam_ocs = glm::mat4(1.0f);
              //cam_ocs = glm::rotate(cam_ocs, -45.0f, glm::vec3(1,0,0));
    ...
    while (window.isOpen())
    {
        ...
        // define each components final model matrix (mm)
        glm::mat4 cam_lens_mm   = cam_lens_wcs   * cam_lens;
        glm::mat4 cam_body_mm   = cam_body_wcs   * cam_body;
        glm::mat4 cam_hing_mm   = cam_hing_wcs   * cam_hing;
        glm::mat4 shaft_hing_mm = shaft_hing_wcs * shaft_hing;
        glm::mat4 shaft_body_mm = shaft_body_wcs * shaft_body;
        glm::mat4 base_hing_mm  = base_hing_wcs  * base_hing;
        glm::mat4 base_body_mm  = base_body_wcs  * base_body;
        glm::mat4 desk_top_mm   = desk_top_wcs   * desk_top;
        glm::mat4 desk_leg_1_mm = desk_leg_1_wcs * desk_leg_1;
        glm::mat4 desk_leg_2_mm = desk_leg_2_wcs * desk_leg_2;
        glm::mat4 desk_leg_3_mm = desk_leg_3_wcs * desk_leg_3;
        glm::mat4 desk_leg_4_mm = desk_leg_4_wcs * desk_leg_4;

        draw_cube(cam_lens_mm   , glm::vec3(0.0f, 0.0f, 1.0f));
        draw_cube(cam_body_mm   , glm::vec3(0.0f, 1.0f, 0.0f));
        draw_cube(cam_hing_mm   , glm::vec3(0.0f, 1.0f, 1.0f));
        draw_cube(shaft_hing_mm , glm::vec3(1.0f, 0.0f, 0.0f));
        draw_cube(shaft_body_mm , glm::vec3(1.0f, 0.0f, 1.0f));
        draw_cube(base_hing_mm  , glm::vec3(1.0f, 0.5f, 0.0f));
        draw_cube(base_body_mm  , glm::vec3(1.0f, 1.0f, 0.5f));
        draw_cube(desk_top_mm   , glm::vec3(0.5f, 0.0f, 1.0f));
        draw_cube(desk_leg_1_mm , glm::vec3(0.5f, 0.0f, 0.5f));
        draw_cube(desk_leg_2_mm , glm::vec3(0.5f, 0.0f, 0.5f));
        draw_cube(desk_leg_3_mm , glm::vec3(0.5f, 0.0f, 0.5f));
        draw_cube(desk_leg_4_mm , glm::vec3(0.5f, 0.0f, 0.5f));
